...
public class audioplugin_GRRNLRRGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_GRRNLRR"; } }
    public override string Description    { get { return "GRRNLRR"; } }
    public override string Vendor         { get { return "Raffael Seyfried"; } }

    //==============================================================================
	[DllImport("audioplugin_GRRNLRR")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_GRRNLRR")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_GRRNLRR")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_GRRNLRR")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_GRRNLRR")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_GRRNLRR")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_GRRNLRR")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
